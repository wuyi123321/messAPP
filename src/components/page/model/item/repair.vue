...
<template>
  <div class="main">
    <div class="header">
      <mu-appbar title="设备维修" style="text-align: center">
        ...
        <div class="searRight">
          ...
          <div class="srcontent">
              <div>
                ...
                <mu-select-field v-model="searchAll['drepairCust.drStatus']" label="维修状态">
                  <mu-menu-item value="-2" title="请选择"/>
                  <mu-menu-item value="-1" title="未审核"/>
                  <mu-menu-item value="0" title="已审核"/>
                  <mu-menu-item value="1" title="维修中"/>
                  <mu-menu-item value="2" title="已修好"/>
                  <mu-menu-item value="3" title="报废"/>
                  <mu-menu-item value="4" title="已使用"/>
                  <mu-menu-item value="5" title="外部维修-维修中"/>
                  <mu-menu-item value="6" title="外部维修-已修复"/>
                  <mu-menu-item value="7" title="外部维修-已提单"/>
                  <mu-menu-item value="8" title="外部维修-保修中"/>
                  <mu-menu-item value="9" title="外部维修-结束"/>
                </mu-select-field>
      ...
      <div class="search">
        ...
        <mu-select-field v-model="searchmess['drepairCust.drFix']" @change="changetype">
          <mu-menu-item value="1" title="内修台账"/>
          <mu-menu-item value="2" title="外修台账"/>
        </mu-select-field>
    ...
    <div style="position: fixed;bottom: 80px;right: 20px">
      <div v-show="allow">
        ...
        <mu-raised-button label="进行维修" ref="button" @click="approve(1)" :disabled="able" primary/>
        <p style="height: 5px"></p>
  ...
  export default {
    ...
    methods: {
      ...
      changetype:function (val) {
        this.searchAll['drepairCust.drFix'] = val;
        console.log(this.searchmess['drepairCust.drFix']);
        console.log( this.searchAll['drepairCust.drFix']);
      },
      showItem:function(val){
          ...
          if(val>=0){
            ...
            this.dataItem.维修状态=this.data[val].drStatus;
...
//      进行级联查询
      ...
      approve:function (type) {
        ...
        vm.allow = false;
        if(vm.dataItemBe.drFix == 1){//内修
          if(vm.dataItemBe.drStatus>=2){
            vm.$message("该设备不在维修状态");
            return 0;
          }
          vm.dataItemBe.drStatus = vm.dataItemBe.drStatus+1
        }
        if(vm.dataItemBe.drFix == 2){
          vm.$message("外修暂时不能进行提单");
          return 0;
        }
       var  pram={};
        ...
        vm.refreshing = true;
        $.ajax({
          url: vm.path+"device2/repairexecute_submit.action",
          dataType: "json",
          data:pram,
          type: "get",
